...
// generateForAd only — an eager elsewhere in this 2800-line file (e.g. the image reframe path)
// is a different concern and must not make this pass or fail.
const fn = src.split('async function generateForAd')[1].split('\nasync function')[0];
