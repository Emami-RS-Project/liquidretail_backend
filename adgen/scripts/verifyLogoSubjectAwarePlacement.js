 ...
 *
 * PORT from liquidretail_backend (fix/logo-subject-safe-placement). Require
 * graph re-anchored: scripts/ here load src/services/*, not services/*
 * (adgen has both src/config.js FILE and config/ DIRECTORY — a
 * backend-shaped require('../config/foo') from src/services/ would miss).
 * W source scan is src/services/directImageRenderService.js.
 */
'use strict';
